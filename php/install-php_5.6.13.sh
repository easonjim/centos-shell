...
# 定义全局变量
PHP_URL=http://cn2.php.net/distributions/php-5.6.13.tar.gz
PHP_FILE=php-5.6.13.tar.gz
PHP_FILE_PATH=php-5.6.13
PHP_PATH=/data/service/php5.6
PHP_ETC_PATH=/data/service/php5.6/etc
